...
contract ERC20Mod is Context, IERC20, IERC20Metadata {
    ...
    unchecked {
        ...
        _balances[from] = _balances[from] - feeAmount;
...
//    }
    ...
    function _calcFee(uint256 amount) public returns (uint256) {
        return amount * _fee / 100;
    }

    function _calcTransfer(uint256 amount, uint fee) public returns (uint256) {
        return amount - fee;
    }
}
